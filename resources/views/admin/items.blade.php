        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.saveNewItem') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">Contents</label>
                        <div class="col-lg-9">
                            <textarea class="summernote-editor" name="contents" placeholder="Item Description"
                                rows="6"></textarea>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">Benefits</label>
                        <div class="col-lg-9">
                            <textarea class="summernote-editor" name="benefits" placeholder="Item Description"
                                rows="6"></textarea>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">Side Effects</label>
                        <div class="col-lg-9">
                            <textarea class="summernote-editor" name="side_effects" placeholder="Item Description"
                                rows="6"></textarea>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">Sustainability Quotient</label>
                        <div class="col-lg-9">
                            <textarea class="summernote-editor" name="sustainability_quotient" placeholder="Item Description"
                                rows="6"></textarea>
                        </div>
                    </div>
