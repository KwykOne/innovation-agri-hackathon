            ...
            <div class="card-body">
                <form action="{{ route('admin.updateAddonCategory') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row @if($addonCategory->type == "SINGLE") hidden @endif" id="addonLimitInputBlock">
                      <label class="col-lg-3 col-form-label">Limit <i class="icon-question3 ml-1" data-popup="tooltip" title="Max number of addons that can be selected by the customer" data-placement="top"></i></label>
                      <div class="col-lg-9">
                       <input value="{{ $addonCategory->addon_limit }}" type="text" class="form-control form-control-lg" name="addon_limit" placeholder="Addon Selection Limit" value="0">
