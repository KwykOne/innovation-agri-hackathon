            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('restaurant.updateRestaurant') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label">Express Delivery Charge:</label>
                            <div class="col-lg-9">
                                <input type="text" value="{{ $restaurant->express_delivery_charge }}" class="form-control form-control-lg express_delivery_charge" name="express_delivery_charge" placeholder="Express Delivery Charge in {{ config('settings.currencyFormat') }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7">
                                <input type="text" value="{{ $restaurant->phone1 }}" class="form-control form-control-lg" name="phone1"
                                    placeholder="Phone 1">
                            </div>
                            <div class="col-lg-2">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                    <input value="true" type="checkbox" class="switchery-primary" @if($restaurant->enable_phone1) checked="checked" @endif name="enable_phone1">
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7">
                                <input type="text" value="{{ $restaurant->phone2 }}" class="form-control form-control-lg" name="phone2" placeholder="Phone 2">
                            </div>
                            <div class="col-lg-2">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                    <input value="true" type="checkbox" class="switchery-primary" @if($restaurant->enable_phone2) checked="checked" @endif name="enable_phone2">
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label">Delivery Time Slot?</label>
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                    <input value="timeslot" type="checkbox" class="switchery-primary" @if($restaurant->delivery_time_slot) checked="checked" @endif name="delivery_time_slot">
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="timeslot" style="display: none">
                            <div class="form-group">
                                <div class="col-lg-12 row">
                                    <div class="col-lg-4">
                                        <label class="col-lg-12 col-form-label">Time Slot 1 (From-To):</label>
                                    </div>
                                    <div class="col-lg-3">
                                        <input value="@if (!empty($restaurant->timeslot1)){{  explode('-', $restaurant->timeslot1)[0] }}@endif" type="time" class="form-control form-control-lg" name="fromtime1"
                                        placeholder="From">
                                    </div>
                                    <div class="col-lg-3">
                                        <input value="@if (!empty($restaurant->timeslot1)){{  explode('-', $restaurant->timeslot1)[1] }}@endif" type="time" class="form-control form-control-lg" name="totime1"
                                        placeholder="From">
                                    </div>
                                    <div class="col-lg-2">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                            <input value="true" type="checkbox" class="switchery-primary" @if($restaurant->enable_timeslot1) checked="checked" @endif name="enable_timeslot1">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-lg-12 row">
                                    <div class="col-lg-4">
                                        <label class="col-lg-12 col-form-label">Time Slot 2 (From-To):</label>
                                    </div>
                                    <div class="col-lg-3">
                                        <input value="@if (!empty($restaurant->timeslot2)){{ explode('-', $restaurant->timeslot2)[0] }}@endif" type="time" class="form-control form-control-lg" name="fromtime2"
                                        placeholder="From">
                                    </div>
                                    <div class="col-lg-3">
                                        <input value="@if (!empty($restaurant->timeslot2)){{  explode('-', $restaurant->timeslot2)[1] }}@endif" type="time" class="form-control form-control-lg" name="totime2"
                                        placeholder="From">
                                    </div>
                                    <div class="col-lg-2">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                            <input value="true" type="checkbox" class="switchery-primary" @if($restaurant->enable_timeslot2) checked="checked" @endif name="enable_timeslot2">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-lg-12 row">
                                    <div class="col-lg-4">
                                        <label class="col-lg-12 col-form-label">Time Slot 3 (From-To):</label>
                                    </div>
                                    <div class="col-lg-3">
                                        <input value="@if (!empty($restaurant->timeslot3)){{ explode('-', $restaurant->timeslot3)[0] }}@endif" type="time" class="form-control form-control-lg" name="fromtime3"
                                        placeholder="From">
                                    </div>
                                    <div class="col-lg-3">
                                        <input value="@if (!empty($restaurant->timeslot3)){{  explode('-', $restaurant->timeslot3)[1] }}@endif" type="time" class="form-control form-control-lg" name="totime3"
                                        placeholder="From">
                                    </div>
                                    <div class="col-lg-2">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                            <input value="true" type="checkbox" class="switchery-primary" @if($restaurant->enable_timeslot3) checked="checked" @endif name="enable_timeslot3">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-lg-12 row">
                                    <div class="col-lg-4">
                                        <label class="col-lg-12 col-form-label">Same Day Time Slot (From-To):</label>
                                    </div>
                                    <div class="col-lg-3">
                                        <input value="@if (!empty($restaurant->same_day_timeslot)){{ explode('-', $restaurant->same_day_timeslot)[0] }}@endif" type="time" class="form-control form-control-lg" name="fromtime4"
                                        placeholder="From">
                                    </div>
                                    <div class="col-lg-3">
                                        <input value="@if (!empty($restaurant->same_day_timeslot)){{  explode('-', $restaurant->same_day_timeslot)[1] }}@endif" type="time" class="form-control form-control-lg" name="totime4"
                                        placeholder="From">
                                    </div>
                                    <div class="col-lg-2">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                            <input value="true" type="checkbox" class="switchery-primary" @if($restaurant->enable_same_day_timeslot) checked="checked" @endif name="enable_same_day_timeslot">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-lg-12 row">
                                    <div class="col-lg-4">
                                        <label class="col-lg-12 col-form-label"><span class="text-danger">*</span>Delivery Limit:</label>
                                    </div>
                                    <div class="col-lg-6">
                                        <input value="@if (!empty($restaurant->delivery_limit)){{ $restaurant->delivery_limit }}@endif" type="text" class="form-control form-control-lg delivery_limit" name="delivery_limit"
                                        placeholder="50">
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    $(function () {
       ...
       @if($restaurant->delivery_time_slot == 1)
