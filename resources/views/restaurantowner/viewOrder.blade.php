                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <p><b>Delivery Type :</b>EXPRESS DELIVERY</p>
                                        @else
                                        <?php $time=explode('-', $order->delivery_timeslot);?>
                                        <p><b>Delivery Date :</b> {{ $order->delivery_date}} </p>
                                        <p><b>Delivery Time :</b> {{  date("h:i A", strtotime(isset($time[0]) ? $time[0] : null)).'-'.date("h:i A", strtotime(isset($time[1]) ? $time[1] : null))}}</p>
                                        @endif
