            ...
            <div class="modal-body">
                <form action="{{ route('restaurant.saveNewRestaurant') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg express_delivery_charge" name="express_delivery_charge"
                                placeholder="Express Delivery Charge in {{ config('settings.currencyFormat') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <div class="checkbox checkbox-switchery mt-2">
                                <label>
                                <input value="timeslot" type="checkbox" class="switchery-primary" name="delivery_time_slot">
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="timeslot" style="display: none;">
                        <div class="form-group">
                            <div class="col-lg-12 row">
                                ...
                                <div class="col-lg-3">
                                    <input type="time" class="form-control form-control-lg" name="fromtime1"  id="fromtime1"
                                    placeholder="From">
                                </div>
                                <div class="col-lg-3">
                                    <input type="time" class="form-control form-control-lg" name="totime1"
                                    placeholder="To">
                                </div>
                                <div class="col-lg-2">
                                    <div class="checkbox checkbox-switchery mt-2">
                                        <label>
                                        <input value="true" type="checkbox" class="switchery-primary" checked="checked" name="enable_timeslot1">
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-12 row">
                                ...
                                <div class="col-lg-3">
                                    <input type="time" class="form-control form-control-lg" name="fromtime2"
                                    placeholder="From">
                                </div>
                                <div class="col-lg-3">
                                    <input type="time" class="form-control form-control-lg" name="totime2"
                                    placeholder="To">
                                </div>
                                <div class="col-lg-2">
                                    <div class="checkbox checkbox-switchery mt-2">
                                        <label>
                                        <input value="true" type="checkbox" class="switchery-primary" checked="checked" name="enable_timeslot2">
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-12 row">
                                ...
                                <div class="col-lg-3">
                                    <input type="time" class="form-control form-control-lg" name="fromtime3"
                                    placeholder="From">
                                </div>
                                <div class="col-lg-3">
                                    <input type="time" class="form-control form-control-lg" name="totime3"
                                    placeholder="To">
                                </div>
                                <div class="col-lg-2">
                                    <div class="checkbox checkbox-switchery mt-2">
                                        <label>
                                        <input value="true" type="checkbox" class="switchery-primary" checked="checked" name="enable_timeslot3">
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-12 row">
                                ...
                                <div class="col-lg-3">
                                    <input type="time" class="form-control form-control-lg" name="fromtime4"
                                    placeholder="From">
                                </div>
                                <div class="col-lg-3">
                                    <input type="time" class="form-control form-control-lg" name="totime4"
                                    placeholder="From">
                                </div>
                                <div class="col-lg-2">
                                    <div class="checkbox checkbox-switchery mt-2">
                                        <label>
                                        <input value="true" type="checkbox" class="switchery-primary" checked="checked" name="enable_same_day_timeslot">
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-12 row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control form-control-lg delivery_limit" name="delivery_limit"
                                    placeholder="50">
                                </div>
                            </div>
                        </div>
