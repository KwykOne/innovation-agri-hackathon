...
class AdminController extends Controller
{
    ...
    public function saveNewItem(Request $request)
    {
        ...
        $item->side_effects = $request->side_effects;
        $item->sustainability_quotient = $request->sustainability_quotient;
        ...
        if ($request->eco_friendly == 'true') {
            $item->eco_friendly = true;
        } else {
            $item->eco_friendly = false;
        }
